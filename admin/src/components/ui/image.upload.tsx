...
const ImageUpload = ({ value, onChange, disabled }: ImageUploadProps) => {
    ...
    const { getRootProps, getInputProps } = useDropzone({
        ...
        maxFiles: 1,
        disabled,
        onDrop: async (acceptedFiles: string | any[]) => {
            ...
            <CardContent className="p-0">
                ...
                >
                    ...
                    {preview ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-50 w-full border border-dashed border-muted-foreground/50 rounded-md">
