    ...
    return (
        ...
        >
            <motion.div
                ...
                ref={sidebarRef}
                className="min-w-72 max-w-96 bg-white text-black z-50 h-screen border-r border-r-red-300 flex flex-col gap-6 relative"
            >
                <div className="flex items-center justify-baseline border-b p-5">
                    <Link href={"/"} className="flex items-end gap-2">
                        <Image src={logo} alt="smallLogo" className="w-8" />
