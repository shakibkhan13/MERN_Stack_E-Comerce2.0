    ...
    return (
        <div ref={searchRef} className="relative lg:w-full">
            ...
            <button
                ...
                className="lg:hidden mt-1.5 border p-2 rounded-full hover:border-gray-400 hover:bg-gray-400/10 group hoverEffect"
            >
                {showSearch ? (
                    <X className="w-5 h-5 text-black group-hover:text-red-400 hoverEffect" />
                ) : (
                    <Search className="w-5 h-5 text-black group-hover:text-red-400 hoverEffect" />
                )}
            </button>
            <form
            ...
            >
                <Input
                    ...
                    className="flex-1 rounded-md py-5 focus-visible:ring-0 focus-visible:border-red-400 bg-white text-black placeholder:font-semibold placeholder:tracking-wide pr-16"
                    value={search}
                ...
                {search ? (
                    <X
                        onClick={() => setSearch("")}
                        className="w-5 h-5 absolute right-3 top-2.5 text-black hover:text-red-400 hoverEffect cursor-pointer"
                    />
                ) : (
                        ...
                        <div className="bg-white p-4 shadow-lg rounded-md">
                            <div className="relative flex items-center">
                                <Input
                                    ref={mobileInputRef}
                                    placeholder="Search Products..."
                                    className="w-full pr-16 py-5 rounded-md focus-visible:ring-0 focus-visible:border-red-400 bg-white text-black placeholder:font-semibold"
                                    value={search}
                                    onChange={(e) => setSearch(e.target.value)}
                                    onFocus={() => setShowResults(true)}
                                />
                                {search ? (
                                    <X
                                        onClick={() => setSearch("")}
                                        className="absolute right-4 w-5 h-5 text-black hover:text-red-400 hoverEffect cursor-pointer"
                                    />
                                ) : (
                                ...
                                {featuredProducts?.length > 0 &&
                                    featuredProducts?.map((item) => (
                                        ...
                                        >
                                            ...
                                            >
                                                <Search className="text-black/60 w-5 h-5" />
                                                <h3 className="text-sm font-medium text-gray-800 line-clamp-1">
                                                    {item?.name}
                                                </h3>
                                            </button>
