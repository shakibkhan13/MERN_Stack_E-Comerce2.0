...
const UserButton = () => {
    ...
    return (
        <Link
            ...
            className="flex items-center gap-2 group hover:text-gray-400 hoverEffect"
        >
            {isAuthenticated && authUser ? (
                <span className="w-10 h-10 border rounded-full p-1 group-hover:border-gray-text-gray-400 hoverEffect">
                    {authUser.avatar ? (
                        <Image
                            src={authUser.avatar}
                            alt="userImage"
