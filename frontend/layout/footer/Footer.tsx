    ...
    return (
        <footer className="w-full bg-white">
            ...
            <Container className="py-10 hidden md:grid grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <div className="flex flex-col gap-2">
                        {informationTab?.map((item) => (
                            <Link
                                key={item?.href}
                                href={item?.href}
                                className="text-black hover:text-gray-400 hoverEffect"
                            >
                                {item?.title}
                            </Link>
                        ))}
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-2 relative">
                        ...
                        />
                        <Button className="bg-gray-400 text-white w-14 h-14 rounded-full flex items-center justify-center absolute top-0 right-0">
                            <ArrowRight />
                        </Button>
                    </div>
                </div>
            ...
            <Container className="py-5 flex flex-col md:flex-row md:items-center justify-between gap-2 md:gap-5">
                <p>© 2026 SKS_Store Theme. All rights reserved.</p>
